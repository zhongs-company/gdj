        ...
        <div class="contentBox">
            ...
            <ul class="peixunList">
                <li class="item" v-for="(li, index) in list" :key="index" @click="toDetail(li.classId)">
                    ...
                    <span>{{li.memo}}</span>
                    <!-- <div class="btn on">培训报名</div> -->

                    <div v-if="li.classPhase==='training'" class="btn on">培训中</div>
                    <div v-if="li.classPhase==='waitbegin'" class="btn on">待开始</div>
                    <div v-if="li.classPhase === 'evaluate'" class="btn on">培训评估</div>
                    <div v-if="(li.classPhase === 'enroll' && isApplyed === 'N')" class="btn on">培训报名</div>
                    <div v-if="(li.classPhase === 'enroll' && isApplyed === 'Y')" class="btn on">已报名</div>
                    <div v-if="li.classPhase === 'course'" class="btn on">开课中</div>
                    <div v-if="li.classPhase === 'exam'" class="btn on">考试中</div>
                    <div v-if="li.classPhase === 'sign'" class="btn on">培训签到</div>
                    <div v-if="li.classPhase === 'complete'" class="btn on">已完成</div>
                </li>
            </ul>
        </div>
...
export default {
  ...
  created() {
    ...
    $.ajax({
      url:
        "http://ucenter.pomesoft.com/sems-ucenter/" +
        "jssdk.jhtml?appCode=" +
        config.app_code,
      data: {
