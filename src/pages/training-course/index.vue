...
export default {
    ...
    mounted() {
        document.querySelector('.peixunList').addEventListener('scroll', utils.throttle(() => {
    ...
    methods: {
        ...
        scanQRcode() {
            ...
            wx.scanQRCode({
                ...
                success: function(res) {
                    ...
                    var signId = utils.getParam('signId', result);
                    if (signId) {
                        api.qd(signId, () => {
        ...
        toDetail(classId){
        	classId && this.$store.dispatch('pxb_getDetail', {classId})
        }
    }
};
