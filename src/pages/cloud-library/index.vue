<template>
    <div class="body">
        <div class="contentBox">
            ...
            <div class="listBox" v-scroll v-pull="scrollObj">
                <transition name="down" mode="out-in">
                    <ul class="species" v-show="isShowTab">
                        <li v-for="(item, index) in classTab" @click="getClassList(item.typeId)">{{item.typeName}}</li>
                    </ul>
                </transition>
                <ul class="picBox">
                    <li v-for="(item, index) in list" :key="index">
                        <div class="piclist">
                            ...
                            <div class="zan">
                                <span @click="zan(item.courseId)"><i class="heart"></i>{{item.upCount}}</span>
            ...
            <!-- <div class="bottom">
            <div class="left on"><i></i>热门课程</div>
            <div class="right"><i></i>收藏课程</div>
        </div> -->
        </div>
    ...
    .listBox {
        ...
        .picBox {
            ...
            li {
                ...
                img {
                    @include wh(333, 154); // height: auto;
                }
                .text {
                    color: #040404;
                    font-size: $addFontSize4;
